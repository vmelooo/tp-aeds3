...
public class TarefaController {
    ...
    /**
     * READ - Lista tarefas por usuário
     */
    public void listarTarefasPorUsuario() {
        try {
            ...
            if (lista.isEmpty()) {
                view.exibirMensagem("Nenhuma tarefa ativa encontrada para o Usuário " + u.getNome() + " (ID " + idUsuario + ").");
                return;
            }
    ...
    public void atualizarTarefa() {
        try {
            ...
            String novoIdUsuarioStr = view.lerTexto("Novo ID de Usuário (Atual: " + t.getIdUsuario() + ". Enter para manter): ");
    ...
    /**
     * DELETE - Exclusão lógica de uma tarefa
     */
    ...
    /**
     * Gerencia categorias de uma tarefa (Relacionamento N:N)
     */
    public void gerenciarCategoriasTarefa() {
        try {
            ...
            if (opcao.equals("1")) {
                ...
                if (arquivoTarefaCategoria.create(new TarefaCategoria(idTarefa, idCategoria, prioridade))) {
    ...
    /**
     * Helper: Lista status ativos
     */
    private void listarStatus() {
        try {
            List<StatusTarefa> lista = arquivoStatus.listarTodos();
            if (lista.isEmpty()) {
    ...
    /**
     * Helper: Lista categorias ativas
     */
